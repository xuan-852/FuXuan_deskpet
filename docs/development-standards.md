...
当前正式节日范围固定为新春、元宵、端午、七夕、中秋。五个主题已完成代码实现、隔离自动验证、`static/small/motion/default_recovery` Unity 截图和视觉预审；综合预评分为 91/92/91/91/91，当前无 P0/P1/P2。真实 GUI 双击展开和拖拽/收回仍必须由负责人逐主题完成并签字，未关闭 T3/T5 前不得把主题、T6 或 G1～G5 标记为最终完成。状态详情见 [`holiday-skin-evaluation-2026-08-31.md`](holiday-skin-evaluation-2026-08-31.md) 和 [`task-inventory.md`](task-inventory.md)。
