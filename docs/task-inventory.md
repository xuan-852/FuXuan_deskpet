...
> 文件版本: N40+ · 最后更新: 2026-09-04（五个传统节日完成逐主题截图、命令日志和视觉预审；当前基线 `37ac7e2`，T3/T5 待真实 GUI 签字，T6 暂不关闭）
>
...
单节日只有在综合评分至少 85/100、无 P0/P1/P2、自动验证和人工审核证据齐全、默认主题恢复正常、生产数据零污染、Live2D 未修改，并且相关文档同步完成后，才能改为 ✅。本轮五个主题已完成 T0、T1、T2、T4 和截图视觉预审；T3/T5 仍等待真实 GUI 双击/拖拽签字，T6 必须在其后完成文件范围复核、文档归档和推送。`37ac7e2` 是本轮开始时的远端基线，不代表五个主题已经最终验收。具体步骤和记录字段见 [`holiday-skin-development-guide.md`](holiday-skin-development-guide.md) 与 [`holiday-skin-review-standard.md`](holiday-skin-review-standard.md)。
