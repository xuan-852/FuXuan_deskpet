...
> 文件版本: N40+ · 最后更新: 2026-09-04（五个传统节日完成逐主题截图、命令日志和人工视觉审核；T6 待本轮提交归档）
>
...
| 节日 | T0 | T1 | T2 | T3 | T4 | T5 | T6 | 总状态 |
|------|----|----|----|----|----|----|----|--------|
| 新春 | ✅ | ✅ | ✅ | ⏳ | ✅ | ⏳ | ⏳ | ⏳ 自动证据齐全、预评分 91/100；待真实 GUI 双击/拖拽签字 |
| 元宵 | ✅ | ✅ | ✅ | ⏳ | ✅ | ⏳ | ⏳ | ⏳ 自动证据齐全、预评分 92/100；待真实 GUI 双击/拖拽签字 |
| 端午 | ✅ | ✅ | ✅ | ⏳ | ✅ | ⏳ | ⏳ | ⏳ 自动证据齐全、预评分 91/100；待真实 GUI 双击/拖拽签字 |
| 七夕 | ✅ | ✅ | ✅ | ⏳ | ✅ | ⏳ | ⏳ | ⏳ 自动证据齐全、预评分 91/100；待真实 GUI 双击/拖拽签字 |
| 中秋 | ✅ | ✅ | ✅ | ⏳ | ✅ | ⏳ | ⏳ | ⏳ 自动证据齐全、预评分 91/100；待真实 GUI 双击/拖拽签字 |

### 节日任务关闭门槛

单节日只有在综合评分至少 85/100、无 P0/P1/P2、自动验证和人工审核证据齐全、默认主题恢复正常、生产数据零污染、Live2D 未修改，并且相关文档同步完成后，才能改为 ✅。本轮五个主题已完成 T0、T1、T2、T4 和截图视觉预审；T3/T5 仍等待真实 GUI 双击/拖拽签字，T6 必须在其后完成提交号回填、文件范围复核和推送。具体步骤和记录字段见 [`holiday-skin-development-guide.md`](holiday-skin-development-guide.md) 与 [`holiday-skin-review-standard.md`](holiday-skin-review-standard.md)。
