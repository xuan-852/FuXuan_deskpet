...
> 文件版本: N40+ · 最后更新: 2026-09-03（按代码真相审计修订，补入节日皮肤专项目标、T0～T6 任务卡和独立验收门槛）
>
...
| G3 | 建立可追溯验收闭环 | 每个主题具备构建、隔离冒烟、三图截图、日志、评分和问题记录 |
...
|------|----|----|----|----|----|----|----|--------|
| 新春 | 🔧 | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | 🔧 已《元日》诗词驱动，待确认与适配验收 |
| 元宵 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ 已完成 |
| 端午 | ✅ | ✅ | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ 待当前版本归档验收 |
| 七夕 | 🔧 | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | 🔧 已《鹊桥仙》诗词驱动，待确认与适配验收 |
| 中秋 | 🔧 | ✅ | ✅ | ⏳ | ⏳ | ⏳ | ⏳ | 🔧 已《水调歌头》诗词驱动，待确认与适配验收 |

### 节日任务关闭门槛

单节日只有在综合评分至少 85/100、无 P0/P1、自动验证和人工审核证据齐全、默认主题恢复正常、生产数据零污染、Live2D 未修改，并且相关文档同步完成后，才能改为 ✅。具体步骤和记录字段见 [`holiday-skin-development-guide.md`](holiday-skin-development-guide.md) 与 [`holiday-skin-review-standard.md`](holiday-skin-review-standard.md)。
