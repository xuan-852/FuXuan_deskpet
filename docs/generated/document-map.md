...
- [L1 运行时稳定性与恢复指导文档](../../docs/guides/approved/l1-runtime-foundation.md) — `docs/guides/approved/l1-runtime-foundation.md`
- [L2 桌面身体、窗口与输入指导文档](../../docs/guides/approved/l2-desktop-body-and-window.md) — `docs/guides/approved/l2-desktop-body-and-window.md`
