...
Unity（团结引擎 Tuanjie 2022.3.62t7）+ Live2D 的 Windows 桌面 AI 伴侣「符玄」，具备感知-决策-执行-记忆闭环，内置 62 个工具，通过本地 Node.js 桥接调用 OpenClaw AI 与 Python 办公生成器。
...
| 工具系统 | [`docs/modules/tool-engine.md`](docs/modules/tool-engine.md) | 62 工具、审批、benchmark |
