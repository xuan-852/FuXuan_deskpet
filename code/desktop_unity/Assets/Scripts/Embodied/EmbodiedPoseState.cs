...
public static class BodyWriterInventory
{
    private static readonly BodyWriterDescriptor[] Descriptors =
    {
        ...
        new BodyWriterDescriptor { WriterId = "walk-pose", Resources = EmbodiedResource.Movement | EmbodiedResource.Body | EmbodiedResource.LeftArm | EmbodiedResource.RightArm, ControlLevel = BodyWriterControlLevel.LegacyUnmanaged, RecoveryOwner = "walking-state" },
        new BodyWriterDescriptor { WriterId = "desktop-physics", Resources = EmbodiedResource.Movement | EmbodiedResource.Body | EmbodiedResource.Effect, ControlLevel = BodyWriterControlLevel.LegacyUnmanaged, RecoveryOwner = "physics-state" },
        ...
        new BodyWriterDescriptor { WriterId = "drag-response", Resources = EmbodiedResource.Movement | EmbodiedResource.Body | EmbodiedResource.Face | EmbodiedResource.LeftArm | EmbodiedResource.RightArm | EmbodiedResource.Effect, ControlLevel = BodyWriterControlLevel.LegacyUnmanaged, RecoveryOwner = "drag-release" }
    };
