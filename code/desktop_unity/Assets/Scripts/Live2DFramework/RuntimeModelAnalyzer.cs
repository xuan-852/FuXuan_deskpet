...
{
    private static readonly Dictionary<string, string> KNOWN_PATTERNS = KnownParameterPatterns.KNOWN_PATTERNS;

    /// <summary>标准语义名列表（用于模板生成）</summary>
    public static readonly string[] STANDARD_SEMANTICS = KnownParameterPatterns.STANDARD_SEMANTICS;
